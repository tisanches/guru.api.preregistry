...
const SELECTPREREGISTRYSTEP = "SELECT EMAIL, NAME, DOCUMENT_NUMBER, CONTACT, REFERRAL, CUSTOMER_CODE FROM CUSTOMER.PREREGISTRYSTEP WHERE EMAIL = $1"
const SELECTPREREGISTRYSTEPBYCUSTOMERCODE = "SELECT EMAIL, NAME, DOCUMENT_NUMBER, CONTACT, REFERRAL, CUSTOMER_CODE FROM CUSTOMER.PREREGISTRYSTEP WHERE CUSTOMER_CODE = $1"
const DELETEPREREGISTRYSTEP = "DELETE FROM CUSTOMER.PREREGISTRYSTEP WHERE EMAIL = $1"

var INSERTPREREGISTRYSTEP  =
	"INSERT INTO CUSTOMER.PREREGISTRYSTEP (EMAIL, NAME, DOCUMENT_NUMBER, CONTACT, REFERRAL, CUSTOMER_CODE ) VALUES ( " + EMAIL +
		"," + NAME + "," + DOCUMENT_NUMBER + "," + CONTACT + "," + REFERRAL_CODE + "," + CUSTOMER_CODE + ") ON CONFLICT (EMAIL) DO UPDATE SET " + "@"
